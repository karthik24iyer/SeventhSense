...
namespace offsets
{
	...
	constexpr ptrdiff_t dwEntityList = 0x4DBF75C;
	constexpr ptrdiff_t dwForceAttack = 0x31EFCD4;
	constexpr ptrdiff_t dwForceAttack2 = 0x31EFCE0;
	constexpr ptrdiff_t dwForceBackward = 0x31EFC8C;
	constexpr ptrdiff_t dwForceForward = 0x31EFC98;
	constexpr ptrdiff_t dwForceJump = 0x5269570;
	constexpr ptrdiff_t dwForceLeft = 0x31EFCB0;
	constexpr ptrdiff_t dwForceRight = 0x31EFCA4;
	constexpr ptrdiff_t dwGameDir = 0x627700;
	constexpr ptrdiff_t dwGameRulesProxy = 0x52DC84C;
	constexpr ptrdiff_t dwGetAllClasses = 0xDCDA84;
	constexpr ptrdiff_t dwGlobalVars = 0x588CF0;
	constexpr ptrdiff_t dwGlowObjectManager = 0x5307C48;
	constexpr ptrdiff_t dwInput = 0x5210D20;
	constexpr ptrdiff_t dwInterfaceLinkList = 0x956AA4;
	constexpr ptrdiff_t dwLocalPlayer = 0xDA544C;
	constexpr ptrdiff_t dwMouseEnable = 0xDAAF98;
	constexpr ptrdiff_t dwMouseEnablePtr = 0xDAAF68;
	constexpr ptrdiff_t dwPlayerResource = 0x31EE000;
	constexpr ptrdiff_t dwRadarBase = 0x51F44D4;
	constexpr ptrdiff_t dwSensitivity = 0xDAAE34;
	constexpr ptrdiff_t dwSensitivityPtr = 0xDAAE08;
	constexpr ptrdiff_t dwSetClanTag = 0x8A130;
	constexpr ptrdiff_t dwViewMatrix = 0x4DB1074;
	constexpr ptrdiff_t dwWeaponTable = 0x52117E4;
	constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
	constexpr ptrdiff_t dwYawPtr = 0xDAABF8;
	constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDAFE98;
	...
	constexpr ptrdiff_t m_yawClassPtr = 0xDAABF8;
	constexpr ptrdiff_t m_pitchClassPtr = 0x51F4770;
	...
	constexpr ptrdiff_t set_abs_angles = 0x1E3D90;
	constexpr ptrdiff_t set_abs_origin = 0x1E3BD0;
	constexpr ptrdiff_t is_c4_owner = 0x3C0E50;
	constexpr ptrdiff_t force_update_spectator_glow = 0x3B3EFA;
	constexpr ptrdiff_t anim_overlays = 0x2990;
	constexpr ptrdiff_t m_flSpawnTime = 0x103C0;
	constexpr ptrdiff_t find_hud_element = 0x2ACC2EA0;
